...
$lang = array_merge($lang, array(
	'LATEST_ANNOUNCEMENTS'		=> 'Последние общие объявления',
	'GLOBAL_ANNOUNCEMENTS'		=> 'Общие объявления',
	'GLOBAL_ANNOUNCEMENT'		=> 'Общее объявление',
	'VIEW_LATEST_ANNOUNCEMENT'  => '1 объявление',
	'VIEW_LATEST_ANNOUNCEMENTS' => '%d объявлений',
	'READ_FULL'					=> 'Смотреть все',
	'NO_ANNOUNCEMENTS'			=> 'Нет общих объявлений',
	'POSTED_BY'					=> 'Автор',
	'COMMENTS'					=> 'Комментарии',
	'VIEW_COMMENTS'				=> 'Смотреть комментарии',
	'PORTAL_POST_REPLY'			=> 'Написать комментарии',
	'TOPIC_VIEWS'				=> 'Просмотры',
	'JUMP_NEWEST'				=> 'Перейти к последнему сообщению',
