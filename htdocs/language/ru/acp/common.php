...
$lang = array_merge($lang, array(
	...
	'STATS_BASIC_BASIC'				=> 'Базовая',
	'STATS_BASIC_ADVANCED'			=> 'Расширенная',
	'STATS_BASIC_MISCELLANEOUS'		=> 'Смешанная',
	'STATS_ACTIVITY'				=> 'Активность форумов',
	'STATS_ACTIVITY_FORUMS'			=> 'Форумы',
	'STATS_ACTIVITY_TOPICS'			=> 'Темы',
	'STATS_ACTIVITY_USERS'			=> 'Пользователи',
	'STATS_CONTRIBUTIONS'				=> 'Возможности форума',
	'STATS_CONTRIBUTIONS_ATTACHMENTS'	=> 'Вложения',
	'STATS_CONTRIBUTIONS_POLLS'			=> 'Голосования',
	'STATS_PERIODIC'					=> 'Статистика за периоды',
	'STATS_PERIODIC_DAILY'				=> 'Дневная статистка',
	'STATS_PERIODIC_MONTHLY'			=> 'Месячная статистка',
	'STATS_PERIODIC_HOURLY'				=> 'Почасовая статистка',
	'STATS_SETTINGS'					=> 'Статистика настроек',
	'STATS_SETTINGS_BOARD'				=> 'Настройки форума',
	'STATS_SETTINGS_PROFILE'			=> 'Настройки профиля',
	'STATS_ADDONS'					=> 'Дополнения',
	'STATS_ADDONS_MISCELLANEOUS'	=> 'scapegoat', // do not change
	
	'LOG_STATS_CONFIG_SETTINGS'				=> '<strong>Статистика phpBB: Изменены основные настройки</strong>',
	'LOG_STATS_CONFIG_ADDONS'				=> '<strong>Статистика phpBB: Изменены настройки дополнений</strong>',
	'LOG_STATS_ADDON_REMOVED'				=> '<strong>Статистика phpBB: Удаленно %1$s дополнение</strong>',
	'LOG_STATS_ADDON_ENABLED'				=> '<strong>Статистика phpBB: Включено %1$s дополнение</strong>',
	'LOG_STATS_ADDON_DISABLED'				=> '<strong>Статистика phpBB: Отключено %1$s дополнение</strong>',

	'FIELD_STATS_SHOW'					=> 'Показывать на странице статистики дополнительные поля пользовательского профиля',
	'FIELD_STATS_SHOW_EXPLAIN'			=> 'Включения данной опции позволит отображать дополнительные поля пользовательского профиля в разделе Настройки профиля на странице статистики. Отключенные и скрытые поля отображаться на странице статистики не будут.<br />Отображение этой статистики будет зависеть от типов данных дополнительных полей пользовательского профиля.',
	
	'acl_u_view_stats'		=> array('lang' => 'Может просматривать статистику', 'cat' => 'misc'),
));
