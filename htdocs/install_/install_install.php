...
class install_install extends module
{
	...
	*/
	function check_server_requirements($mode, $sub)
	{
		...
		$template->assign_block_vars('checks', array(
			'S_LEGEND'			=> true,
			'LEGEND'			=> $lang['PHP_SETTINGS_OPTIONAL'],
			'LEGEND_EXPLAIN'	=> $lang['PHP_SETTINGS_OPTIONAL_EXP'],
		));
		...
		{
			$gd_info = gd_info();
			$result = '<strong style="color:red">' . $lang['NO'] . '</strong><br />' . sprintf($lang['OPTIONAL_IMAGEROTATE_EXP'], $gd_info['GD Version']);
		}
		$template->assign_block_vars('checks', array(
			'TITLE'			=> $lang['OPTIONAL_IMAGEROTATE'],
			'TITLE_EXPLAIN'	=> $lang['OPTIONAL_IMAGEROTATE_EXPLAIN'],
			'RESULT'		=> $result,
		...
		{
			$result = '<strong style="color:red">' . $lang['NO'] . '</strong><br />' . $lang['OPTIONAL_EXIFDATA_EXP'];
		}
		$template->assign_block_vars('checks', array(
			'TITLE'			=> $lang['OPTIONAL_EXIFDATA'],
			'TITLE_EXPLAIN'	=> $lang['OPTIONAL_EXIFDATA_EXPLAIN'],
			'RESULT'		=> $result,
...
*/
		...
		$directories = array('cache/', 'files/', 'store/','sitemaps/', 'gallery/images/import/', 'gallery/images/upload/', 'gallery/images/medium/', 'gallery/images/cache/');
	...
	*/
	function add_modules($mode, $sub)
	{
		...
		$module_classes = array('acp', 'mcp', 'ucp', 'stats');
