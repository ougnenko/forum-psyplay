...
CREATE TABLE phpbb_forums (
	...
	forum_recent_topics number(1) DEFAULT '1' NOT NULL,
...
CREATE TABLE phpbb_users (
	...
	user_allow_thanks_email number(1) DEFAULT '0' NOT NULL,
...
CREATE TABLE phpbb_portal_modules (
	module_id number(8)  NOT NULL,
	module_classname varchar2(64) DEFAULT '' NOT NULL,
...
BEGIN
	SELECT phpbb_portal_modules.nextval
	INTO :new.rank_id
	FROM dual;
END;
/
...
CREATE TABLE phpbb_thanks (
	post_id number(8) NOT NULL DEFAULT '0',
	poster_id number(8) NOT NULL DEFAULT '0',
	user_id number(8) NOT NULL DEFAULT '0',
	topic_id number(8) NOT NULL DEFAULT '0',
	forum_id number(8) NOT NULL DEFAULT '0',
	thanks_time number(11) NOT NULL DEFAULT '0',
	CONSTRAINT pk_phpbb_thanks PRIMARY KEY (post_id , user_id)
)
/

CREATE INDEX phpbb_thanks_post_id ON phpbb_thanks (post_id)
/
CREATE INDEX phpbb_thanks_poster_id ON phpbb_thanks (poster_id)
/
CREATE INDEX phpbb_thanks_user_id ON phpbb_thanks (user_id)
/
CREATE INDEX phpbb_thanks_topic_id ON phpbb_thanks (topic_id)
/
CREATE INDEX phpbb_thanks_forum_id ON phpbb_thanks (forum_id)
/
/*

 $Id: _oracle_schema.sql 1356 2010-01-21 10:31:08Z nickvergessen $
...
CREATE TABLE phpbb_gallery_comments (
	...
	comment_signature number(8) DEFAULT '0' NOT NULL,
...
/*
 ...
 $Id: _oracle_schema.sql 1355 2010-01-20 23:29:09Z nickvergessen $
...
CREATE INDEX phpbb_gallery_users_pg_palbum_id ON phpbb_gallery_users (personal_album_id)
/
/*
