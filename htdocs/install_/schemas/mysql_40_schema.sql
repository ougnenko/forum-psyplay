...
CREATE TABLE phpbb_forums (
	...
	forum_recent_topics tinyint(1) UNSIGNED  DEFAULT '1' NOT NULL,
...
CREATE TABLE phpbb_users (
	...
	user_allow_thanks_email tinyint(1) UNSIGNED DEFAULT '0' NOT NULL,
	PRIMARY KEY (user_id),
...
CREATE TABLE phpbb_portal_modules (
	module_id mediumint(8) UNSIGNED NOT NULL auto_increment,
	module_classname varbinary(64)  NOT NULL DEFAULT '',
	module_column tinyint(3) DEFAULT 0 NOT NULL,
	module_order tinyint(3) DEFAULT 0 NOT NULL,
	module_name varbinary(255)  NOT NULL DEFAULT '',
	module_image_src varbinary(255)  NOT NULL DEFAULT '',
	module_image_width int(3) DEFAULT 0 NOT NULL,
	module_image_height int(3) DEFAULT 0 NOT NULL,
	module_group_ids varbinary(255)  NOT NULL DEFAULT '',
...
CREATE TABLE phpbb_thanks (
	...
	topic_id  mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	forum_id  mediumint(8) UNSIGNED DEFAULT '0' NOT NULL,
	thanks_time int(11) UNSIGNED DEFAULT '0' NOT NULL,
...
#
# $Id: _mysql_40_schema.sql 1356 2010-01-21 10:31:08Z nickvergessen $
#
...
CREATE TABLE phpbb_gallery_images (
    ...
    image_allow_comments int(1) UNSIGNED DEFAULT '1' NOT NULL,
