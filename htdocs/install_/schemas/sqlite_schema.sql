...
CREATE TABLE phpbb_forums (
	...
	forum_recent_topics INTEGER UNSIGNED NOT NULL DEFAULT '1'
);
...
CREATE TABLE phpbb_users (
	...
	user_allow_thanks_email INTEGER UNSIGNED DEFAULT '0' NOT NULL
);
...
CREATE TABLE phpbb_thanks (
	...
	topic_id INTEGER UNSIGNED NOT NULL DEFAULT '0',
	forum_id INTEGER UNSIGNED NOT NULL DEFAULT '0',
	thanks_time INTEGER UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE phpbb_gallery_images (
    ...
    image_allow_comments INTEGER UNSIGNED NOT NULL DEFAULT '1',
...
CREATE TABLE phpbb_gallery_users (
	...
	user_allow_comments  INTEGER  NOT NULL DEFAULT '1',
	subscribe_pegas INTEGER  NOT NULL DEFAULT '0',
	PRIMARY KEY (user_id)
);
