...
CREATE TABLE [phpbb_forums] (
	...
	[forum_recent_topics] [int] DEFAULT (1) NOT NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
...
CREATE TABLE [phpbb_users] (
	...
	[user_allow_thanks_email] [int] DEFAULT (0) NOT NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
...
CREATE TABLE [phpbb_thanks] (
	...
	[topic_id] [int] DEFAULT (0) NOT NULL ,
	[forum_id] [int] DEFAULT (0) NOT NULL ,
	[thanks_time] [int] DEFAULT (0) NOT NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO

ALTER TABLE [phpbb_thanks] WITH NOCHECK ADD
	CONSTRAINT [PK_phpbb_thanks] PRIMARY KEY  CLUSTERED
	(
		[post_id],
		[user_id]
	)  ON [PRIMARY]
...
CREATE  INDEX [post_id] ON [phpbb_thanks]([post_id]) ON [PRIMARY]
GO

CREATE  INDEX [poster_id] ON [phpbb_thanks]([poster_id]) ON [PRIMARY]
GO

CREATE  INDEX [user_id] ON [phpbb_thanks]([user_id]) ON [PRIMARY]
GO

CREATE  INDEX [topic_id] ON [phpbb_thanks]([topic_id]) ON [PRIMARY]
GO

CREATE  INDEX [forum_id] ON [phpbb_thanks]([forum_id]) ON [PRIMARY]
GO
...
CREATE TABLE [phpbb_gallery_albums] (
	...
	[album_feed] [int] DEFAULT DEFAULT (1) NOT NULL,
	[album_auth_access] [int] DEFAULT DEFAULT (0) NOT NULL
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
...
CREATE  INDEX [pg_palbum_id] ON [phpbb_gallery_users]([personal_album_id]) ON [PRIMARY]
GO
