...
CREATE TABLE phpbb_forums (
	...
	forum_recent_topics INT2 DEFAULT '1' NOT NULL,
...
CREATE TABLE phpbb_users (
	...
	user_allow_thanks_email INT2 DEFAULT '0' NOT NULL,
	PRIMARY KEY (user_id)
);
...
CREATE TABLE phpbb_thanks (
	...
	thanks_time INT4 NOT NULL DEFAULT '0',
...
CREATE TABLE phpbb_gallery_albums (
	...
	album_feed INT4 DEFAULT '1' NOT NULL CHECK (album_feed >=0),
	album_auth_access INT4 DEFAULT '0' NOT NULL,
...
CREATE TABLE phpbb_gallery_images (
    ...
    image_allow_comments INT4 DEFAULT '1' NOT NULL CHECK (image_allow_comments >= 0),
...
CREATE TABLE phpbb_gallery_users (
	...
	user_allow_comments INT4 DEFAULT '1' NOT NULL CHECK (user_allow_comments >= 0),
	subscribe_pegas INT4 DEFAULT '0' NOT NULL CHECK (subscribe_pegas >= 0),
	PRIMARY KEY (user_id)
);
