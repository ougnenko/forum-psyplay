...
CREATE TABLE phpbb_forums (
	...
	forum_recent_topics INTEGER DEFAULT 1 NOT NULL
);;
...
CREATE TABLE phpbb_users (
	...
	user_allow_thanks_email INTEGER  DEFAULT 0 NOT NULL
);;
...
CREATE TABLE phpbb_thanks (
	...
	topic_id INTEGER DEFAULT 0 NOT NULL,
	forum_id INTEGER DEFAULT 0 NOT NULL,
	thanks_time INTEGER DEFAULT 0 NOT NULL
);;

ALTER TABLE phpbb_thanks ADD PRIMARY KEY PRIMARY KEY (post_id , user_id);;
...
#
# $Id: _firebird_schema.sql 1356 2010-01-21 10:31:08Z nickvergessen $
#
...
#
# $Id: _firebird_schema.sql 1355 2010-01-20 23:29:09Z nickvergessen $
#
