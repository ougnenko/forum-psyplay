...
<!-- begin mod: phpBB Gallery --><?php $this->_tpl_include('gallery/plugins_header.html'); ?><!-- end mod: phpBB Gallery --><?php $this->_tpl_include('prime_show_deleted_post.html'); $this->_tpl_include('mods/reimg_content.html'); ?>
...
<?php if (! $this->_tpldata['DEFINE']['.']['S_IN_PORTAL'] || $this->_rootref['S_DISPLAY_PHPBB_MENU']) {  ?>
		...
		<div class="navbar">
			...
			<ul class="linklist rightside">
				...
				<!-- begin mod: phpBB Statistics --><?php if ($this->_rootref['S_VIEW_STATS']) {  ?><li class="icon-faq"><a href="<?php echo (isset($this->_rootref['U_STATS'])) ? $this->_rootref['U_STATS'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_STATS_EXPLAIN'])) ? $this->_rootref['L_STATS_EXPLAIN'] : ((isset($user->lang['STATS_EXPLAIN'])) ? $user->lang['STATS_EXPLAIN'] : '{ STATS_EXPLAIN }')); ?>"><?php echo ((isset($this->_rootref['L_STATISTICS'])) ? $this->_rootref['L_STATISTICS'] : ((isset($user->lang['STATISTICS'])) ? $user->lang['STATISTICS'] : '{ STATISTICS }')); ?></a></li><?php } ?><!-- end mod: phpBB Statistics --><!-- begin mod: phpBB Gallery -->
<li class="icon-gallery"><a href="<?php echo (isset($this->_rootref['U_GALLERY_MOD'])) ? $this->_rootref['U_GALLERY_MOD'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_GALLERY_EXPLAIN'])) ? $this->_rootref['L_GALLERY_EXPLAIN'] : ((isset($user->lang['GALLERY_EXPLAIN'])) ? $user->lang['GALLERY_EXPLAIN'] : '{ GALLERY_EXPLAIN }')); ?>"><?php echo ((isset($this->_rootref['L_GALLERY'])) ? $this->_rootref['L_GALLERY'] : ((isset($user->lang['GALLERY'])) ? $user->lang['GALLERY'] : '{ GALLERY }')); ?></a></li>
<!-- end mod: phpBB Gallery --><?php if (! $this->_rootref['S_IS_BOT']) {  if ($this->_rootref['S_DISPLAY_MEMBERLIST']) {  ?><li class="icon-members"><a href="<?php echo (isset($this->_rootref['U_MEMBERLIST'])) ? $this->_rootref['U_MEMBERLIST'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_MEMBERLIST_EXPLAIN'])) ? $this->_rootref['L_MEMBERLIST_EXPLAIN'] : ((isset($user->lang['MEMBERLIST_EXPLAIN'])) ? $user->lang['MEMBERLIST_EXPLAIN'] : '{ MEMBERLIST_EXPLAIN }')); ?>"><?php echo ((isset($this->_rootref['L_MEMBERLIST'])) ? $this->_rootref['L_MEMBERLIST'] : ((isset($user->lang['MEMBERLIST'])) ? $user->lang['MEMBERLIST'] : '{ MEMBERLIST }')); ?></a></li><?php } ?><!-- begin mod: Thanks for posts --><?php if ($this->_rootref['S_DISPLAY_TOPLIST']) {  ?><li class="icon-thanks_toplist"><a href="<?php echo (isset($this->_rootref['U_REPUT_TOPLIST'])) ? $this->_rootref['U_REPUT_TOPLIST'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_REPUT_TOPLIST'])) ? $this->_rootref['L_REPUT_TOPLIST'] : ((isset($user->lang['REPUT_TOPLIST'])) ? $user->lang['REPUT_TOPLIST'] : '{ REPUT_TOPLIST }')); ?>"><?php echo ((isset($this->_rootref['L_REPUT_TOPLIST'])) ? $this->_rootref['L_REPUT_TOPLIST'] : ((isset($user->lang['REPUT_TOPLIST'])) ? $user->lang['REPUT_TOPLIST'] : '{ REPUT_TOPLIST }')); ?></a></li><?php } if ($this->_rootref['S_DISPLAY_THANKSLIST']) {  ?><li class="icon-thanks"><a href="<?php echo (isset($this->_rootref['U_THANKSLIST'])) ? $this->_rootref['U_THANKSLIST'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_THANKS_USER'])) ? $this->_rootref['L_THANKS_USER'] : ((isset($user->lang['THANKS_USER'])) ? $user->lang['THANKS_USER'] : '{ THANKS_USER }')); ?>"><?php echo ((isset($this->_rootref['L_GRATITUDES'])) ? $this->_rootref['L_GRATITUDES'] : ((isset($user->lang['GRATITUDES'])) ? $user->lang['GRATITUDES'] : '{ GRATITUDES }')); ?></a></li><?php } ?><!-- end mod: Thanks for posts --><?php if (! $this->_rootref['S_USER_LOGGED_IN'] && $this->_rootref['S_REGISTER_ENABLED'] && ! ( $this->_rootref['S_SHOW_COPPA'] || $this->_rootref['S_REGISTRATION'] )) {  ?><li class="icon-register"><a href="<?php echo (isset($this->_rootref['U_REGISTER'])) ? $this->_rootref['U_REGISTER'] : ''; ?>"><?php echo ((isset($this->_rootref['L_REGISTER'])) ? $this->_rootref['L_REGISTER'] : ((isset($user->lang['REGISTER'])) ? $user->lang['REGISTER'] : '{ REGISTER }')); ?></a></li><?php } ?>
