...
<?php if ($this->_rootref['S_EDIT']) {  ?>
	...
	<dl>
		<dt><label for="group_reputation_power"><?php echo ((isset($this->_rootref['L_RP_GROUP_POWER'])) ? $this->_rootref['L_RP_GROUP_POWER'] : ((isset($user->lang['RP_GROUP_POWER'])) ? $user->lang['RP_GROUP_POWER'] : '{ RP_GROUP_POWER }')); ?>:</label></dt>
		<dd><input name="group_reputation_power" type="text" id="group_reputation_power" maxlength="4" size="4" value="<?php echo (isset($this->_rootref['GROUP_REPUTATION_POWER'])) ? $this->_rootref['GROUP_REPUTATION_POWER'] : ''; ?>" /></dd></dd>
	</dl>
