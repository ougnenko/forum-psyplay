...
<!-- begin mod: phpBB Gallery --><?php $this->_tpl_include('gallery/plugins_header.html'); ?><!-- end mod: phpBB Gallery --><?php $this->_tpl_include('mods/reimg_content.html'); ?>
	...
	<div id="menubar">
		...
		<tr>
			...
			<td class="genmed" align="<?php echo (isset($this->_rootref['S_CONTENT_FLOW_END'])) ? $this->_rootref['S_CONTENT_FLOW_END'] : ''; ?>">
				...
				<a href="<?php echo (isset($this->_rootref['U_GALLERY_MOD'])) ? $this->_rootref['U_GALLERY_MOD'] : ''; ?>" title="<?php echo ((isset($this->_rootref['L_GALLERY_EXPLAIN'])) ? $this->_rootref['L_GALLERY_EXPLAIN'] : ((isset($user->lang['GALLERY_EXPLAIN'])) ? $user->lang['GALLERY_EXPLAIN'] : '{ GALLERY_EXPLAIN }')); ?>"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/icon_mini_gallery.gif" width="12" height="13" alt="*" /> <?php echo ((isset($this->_rootref['L_GALLERY'])) ? $this->_rootref['L_GALLERY'] : ((isset($user->lang['GALLERY'])) ? $user->lang['GALLERY'] : '{ GALLERY }')); ?></a>&nbsp; &nbsp;
				...
				<!-- begin mod: phpBB Statistics - subsilver2 style --><?php if ($this->_rootref['S_VIEW_STATS']) {  ?>&nbsp; &nbsp;<a href="<?php echo (isset($this->_rootref['U_STATS'])) ? $this->_rootref['U_STATS'] : ''; ?>"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/icon_mini_faq.gif" width="12" height="13" alt="*" /> <?php echo ((isset($this->_rootref['L_STATISTICS'])) ? $this->_rootref['L_STATISTICS'] : ((isset($user->lang['STATISTICS'])) ? $user->lang['STATISTICS'] : '{ STATISTICS }')); ?></a><?php } ?><!-- end mod: phpBB Statistics - subsilver2 style --><?php if ($this->_rootref['S_DISPLAY_SEARCH']) {  ?>&nbsp; &nbsp;<a href="<?php echo (isset($this->_rootref['U_SEARCH'])) ? $this->_rootref['U_SEARCH'] : ''; ?>"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/icon_mini_search.gif" width="12" height="13" alt="*" /> <?php echo ((isset($this->_rootref['L_SEARCH'])) ? $this->_rootref['L_SEARCH'] : ((isset($user->lang['SEARCH'])) ? $user->lang['SEARCH'] : '{ SEARCH }')); ?></a><?php } if (! $this->_rootref['S_IS_BOT']) {  if ($this->_rootref['S_DISPLAY_MEMBERLIST']) {  ?>&nbsp; &nbsp;<a href="<?php echo (isset($this->_rootref['U_MEMBERLIST'])) ? $this->_rootref['U_MEMBERLIST'] : ''; ?>"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/icon_mini_members.gif" width="12" height="13" alt="*" /> <?php echo ((isset($this->_rootref['L_MEMBERLIST'])) ? $this->_rootref['L_MEMBERLIST'] : ((isset($user->lang['MEMBERLIST'])) ? $user->lang['MEMBERLIST'] : '{ MEMBERLIST }')); ?></a><?php } ?><!-- begin mod: Thanks for posts (for subsilver2) --><?php if ($this->_rootref['S_DISPLAY_TOPLIST']) {  ?>&nbsp; &nbsp;<a href="<?php echo (isset($this->_rootref['U_REPUT_TOPLIST'])) ? $this->_rootref['U_REPUT_TOPLIST'] : ''; ?>"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/icon_mini_toplist.gif" width="15" height="14" alt="*" /><?php echo ((isset($this->_rootref['L_REPUT_TOPLIST'])) ? $this->_rootref['L_REPUT_TOPLIST'] : ((isset($user->lang['REPUT_TOPLIST'])) ? $user->lang['REPUT_TOPLIST'] : '{ REPUT_TOPLIST }')); ?></a><?php } if ($this->_rootref['S_DISPLAY_THANKSLIST']) {  ?>&nbsp; &nbsp;<a href="<?php echo (isset($this->_rootref['U_THANKSLIST'])) ? $this->_rootref['U_THANKSLIST'] : ''; ?>"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/icon_mini_thanks.gif" width="12" height="13" alt="*" /> <?php echo ((isset($this->_rootref['L_GRATITUDES'])) ? $this->_rootref['L_GRATITUDES'] : ((isset($user->lang['GRATITUDES'])) ? $user->lang['GRATITUDES'] : '{ GRATITUDES }')); ?></a><?php } ?><!-- end mod: Thanks for posts (for subsilver2) --><?php if ($this->_rootref['S_USER_LOGGED_IN']) {  ?>&nbsp; &nbsp;<a href="<?php echo (isset($this->_rootref['U_PROFILE'])) ? $this->_rootref['U_PROFILE'] : ''; ?>"><img src="<?php echo (isset($this->_rootref['T_THEME_PATH'])) ? $this->_rootref['T_THEME_PATH'] : ''; ?>/images/icon_mini_profile.gif" width="12" height="13" alt="*" /> <?php echo ((isset($this->_rootref['L_PROFILE'])) ? $this->_rootref['L_PROFILE'] : ((isset($user->lang['PROFILE'])) ? $user->lang['PROFILE'] : '{ PROFILE }')); ?></a><?php } } ?>
...
<div id="wrapcentre">
<?php if (! $this->_tpldata['DEFINE']['.']['S_IN_PORTAL'] || $this->_rootref['S_DISPLAY_PHPBB_MENU']) {  if ($this->_rootref['S_DISPLAY_SEARCH']) {  ?>
