	...
	<div class="panel bg3" id="options-panel">
		...
		<fieldset class="fields1">
			...
			<?php } if ($this->_rootref['S_FIRST_POST_SHOW_ALLOWED']) {  ?>
				...
				<div><label for="topic_first_post_show"><input type="checkbox" name="topic_first_post_show" id="topic_first_post_show"<?php echo (isset($this->_rootref['S_FIRST_POST_SHOW_CHECKED'])) ? $this->_rootref['S_FIRST_POST_SHOW_CHECKED'] : ''; ?> /> <?php echo ((isset($this->_rootref['L_FIRST_POST_SHOW'])) ? $this->_rootref['L_FIRST_POST_SHOW'] : ((isset($user->lang['FIRST_POST_SHOW'])) ? $user->lang['FIRST_POST_SHOW'] : '{ FIRST_POST_SHOW }')); ?> </label></div>
