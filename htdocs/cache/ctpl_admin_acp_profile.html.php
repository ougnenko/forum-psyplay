...
<?php if ($this->_rootref['S_EDIT']) {  ?>
	...
	<?php if ($this->_rootref['S_STEP_ONE']) {  ?>
		...
		<!-- begin mod: phpBB Statistics --><?php if ($this->_rootref['S_DISPLAY_FIELD_STATS_SHOW']) {  ?>

		<fieldset>
			<legend><?php echo ((isset($this->_rootref['L_STATS'])) ? $this->_rootref['L_STATS'] : ((isset($user->lang['STATS'])) ? $user->lang['STATS'] : '{ STATS }')); ?></legend>
		<dl>
			<dt><label for="field_stats_show"><?php echo ((isset($this->_rootref['L_FIELD_STATS_SHOW'])) ? $this->_rootref['L_FIELD_STATS_SHOW'] : ((isset($user->lang['FIELD_STATS_SHOW'])) ? $user->lang['FIELD_STATS_SHOW'] : '{ FIELD_STATS_SHOW }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_FIELD_STATS_SHOW_EXPLAIN'])) ? $this->_rootref['L_FIELD_STATS_SHOW_EXPLAIN'] : ((isset($user->lang['FIELD_STATS_SHOW_EXPLAIN'])) ? $user->lang['FIELD_STATS_SHOW_EXPLAIN'] : '{ FIELD_STATS_SHOW_EXPLAIN }')); ?></span></dt>
			<dd><label><input type="radio" class="radio" id="field_stats_show" name="field_stats_show" value="1"<?php if ($this->_rootref['S_FIELD_STATS_SHOW']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?></label>
				<label><input type="radio" class="radio" name="field_stats_show" value="0"<?php if (! $this->_rootref['S_FIELD_STATS_SHOW']) {  ?> checked="checked"<?php } ?> /> <?php echo ((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?></label></dd>
		</dl>
		</fieldset>
		<?php } ?><!-- end mod: phpBB Statistics --><?php if ($this->_rootref['S_EDIT_MODE']) {  ?>
