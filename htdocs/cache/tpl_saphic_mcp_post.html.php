...
<div class="panel<?php if ($this->_rootref['S_DELETED']) {  ?> deleted_post<?php } ?>">
	<div class="inner"><span class="corners-top"><span></span></span>
	...
	<div class="postbody">
		...
		<?php } if ($this->_rootref['DELETED_REASON']) {  ?><hr /><strong><?php echo ((isset($this->_rootref['L_PRIME_POST_DELETED_REASON'])) ? $this->_rootref['L_PRIME_POST_DELETED_REASON'] : ((isset($user->lang['PRIME_POST_DELETED_REASON'])) ? $user->lang['PRIME_POST_DELETED_REASON'] : '{ PRIME_POST_DELETED_REASON }')); ?>:</strong> <?php echo (isset($this->_rootref['DELETED_REASON'])) ? $this->_rootref['DELETED_REASON'] : ''; } ?>
