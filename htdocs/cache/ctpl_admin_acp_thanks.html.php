...
<p><?php echo ((isset($this->_rootref['L_ACP_THANKS_MOD_VER'])) ? $this->_rootref['L_ACP_THANKS_MOD_VER'] : ((isset($user->lang['ACP_THANKS_MOD_VER'])) ? $user->lang['ACP_THANKS_MOD_VER'] : '{ ACP_THANKS_MOD_VER }')); echo (isset($this->_rootref['THANKS_MOD_VERSION'])) ? $this->_rootref['THANKS_MOD_VERSION'] : ''; ?></p>
