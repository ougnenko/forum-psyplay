...
<?php if ($this->_rootref['S_TOPIC_DELETED']) {  ?>
	...
	<div id="p0" class="post bg2 deleted_topic">
		<div class="inner"><span class="corners-top"><span></span></span>
		<div class="postbody">
			<h3 class="first"><?php echo ((isset($this->_rootref['L_PRIME_TOPIC_DELETED_MSG'])) ? $this->_rootref['L_PRIME_TOPIC_DELETED_MSG'] : ((isset($user->lang['PRIME_TOPIC_DELETED_MSG'])) ? $user->lang['PRIME_TOPIC_DELETED_MSG'] : '{ PRIME_TOPIC_DELETED_MSG }')); ?></h3>
			<div class="ignore">
				<?php echo (isset($this->_rootref['DELETED_MSG'])) ? $this->_rootref['DELETED_MSG'] : ''; ?>
...
<?php } $_postrow_count = (isset($this->_tpldata['postrow'])) ? sizeof($this->_tpldata['postrow']) : 0;if ($_postrow_count) {for ($_postrow_i = 0; $_postrow_i < $_postrow_count; ++$_postrow_i){$_postrow_val = &$this->_tpldata['postrow'][$_postrow_i]; if ($_postrow_val['S_FIRST_UNREAD']) {  ?><a id="unread"></a><?php } ?>
	...
	<div id="p<?php echo $_postrow_val['POST_ID']; ?>" class="post <?php if (($_postrow_val['S_ROW_COUNT'] & 1)  ) {  ?>bg1<?php } else { ?>bg2<?php } if ($_postrow_val['S_UNREAD_POST']) {  ?> unreadpost<?php } if ($_postrow_val['S_POST_REPORTED']) {  ?> reported<?php } if ($_postrow_val['S_ONLINE'] && ! $_postrow_val['S_IGNORE_POST']) {  ?> online<?php } if ($_postrow_val['S_DELETED']) {  ?> deleted_post<?php } ?>">
		<div class="inner"><span class="corners-top"><span></span></span>
		...
		<div class="postbody">
			...
			<?php } if ($_postrow_val['BUMPED_MESSAGE']) {  ?><div class="notice"><br /><br /><?php echo $_postrow_val['BUMPED_MESSAGE']; ?></div><?php } if ($_postrow_val['SIGNATURE']) {  ?><div id="sig<?php echo $_postrow_val['POST_ID']; ?>" class="signature"><?php echo $_postrow_val['SIGNATURE']; ?></div><?php } } ?><!-- begin mod: Thanks for posts --><?php if ($_postrow_val['THANKS'] && $_postrow_val['THANKS_POSTLIST_VIEW']) {  ?>

			<hr />
			<?php if (! $_postrow_val['S_POST_ANONYMOUS'] && ! $this->_rootref['S_IS_BOT'] && $_postrow_val['S_MOD_THANKS']) {  ?>

			<ul class="profile-icons" style="float:left"><li class="delete-icon"><a href="<?php echo $_postrow_val['U_CLEAR_LIST_THANKS_POST']; ?>" title="<?php echo ((isset($this->_rootref['L_CLEAR_LIST_THANKS'])) ? $this->_rootref['L_CLEAR_LIST_THANKS'] : ((isset($user->lang['CLEAR_LIST_THANKS'])) ? $user->lang['CLEAR_LIST_THANKS'] : '{ CLEAR_LIST_THANKS }')); ?>"><span><?php echo ((isset($this->_rootref['L_CLEAR_LIST_THANKS'])) ? $this->_rootref['L_CLEAR_LIST_THANKS'] : ((isset($user->lang['CLEAR_LIST_THANKS'])) ? $user->lang['CLEAR_LIST_THANKS'] : '{ CLEAR_LIST_THANKS }')); ?></span></a></li></ul>
			<?php } ?>

			<div class="content">
				<?php if (! $_postrow_val['S_POST_ANONYMOUS'] && ! $this->_rootref['S_IS_BOT']) {  ?>

				<dl class="postbody small">
					<dt><?php echo $_postrow_val['THANK_TEXT']; echo $_postrow_val['POST_AUTHOR_FULL']; echo $_postrow_val['THANK_TEXT_2']; ?></dt>
					<dd><?php echo $_postrow_val['THANKS']; ?></dd>
				</dl>
				<?php } ?>

			</div>
		<?php } if ($_postrow_val['S_THANKS_POST_REPUT_VIEW'] && $_postrow_val['POST_REPUT'] && ! $_postrow_val['S_POST_ANONYMOUS'] && ! $this->_rootref['S_IS_BOT']) {  ?>

			<div class="content">
				<dl class="postbody">
					<dt class="small"><strong><?php echo ((isset($this->_rootref['L_REPUT'])) ? $this->_rootref['L_REPUT'] : ((isset($user->lang['REPUT'])) ? $user->lang['REPUT'] : '{ REPUT }')); ?>:</strong>&nbsp;<?php echo $_postrow_val['POST_REPUT']; ?></dt>
					<dd>
					<?php if ($_postrow_val['S_THANKS_REPUT_GRAPHIC']) {  ?>

					<div style="width: <?php echo $_postrow_val['THANKS_REPUT_GRAPHIC_WIDTH']; ?>; height: <?php echo $_postrow_val['THANKS_REPUT_HEIGHT']; ?>; background:  url(<?php echo $_postrow_val['THANKS_REPUT_IMAGE_BACK']; ?>); background-repeat: repeat-x;"><div style="height: <?php echo $_postrow_val['THANKS_REPUT_HEIGHT']; ?>; width: <?php echo $_postrow_val['POST_REPUT']; ?>; background: url(<?php echo $_postrow_val['THANKS_REPUT_IMAGE']; ?>); background-repeat: repeat-x;"></div></div>&nbsp;
					<?php } ?>

					</dd>
				</dl>
			</div>
		<?php } ?><!-- end mod: Thanks for posts -->
		...
		<?php if ($_postrow_val['POSTER_POSTS'] != ('')) {  ?><dd><strong><?php echo ((isset($this->_rootref['L_POSTS'])) ? $this->_rootref['L_POSTS'] : ((isset($user->lang['POSTS'])) ? $user->lang['POSTS'] : '{ POSTS }')); ?>:</strong> <?php echo $_postrow_val['POSTER_POSTS']; ?></dd><?php } ?><!-- begin mod: phpBB Gallery --><?php if ($_postrow_val['GALLERY_IMAGES'] != ('')) {  ?><dd><strong><?php echo ((isset($this->_rootref['L_IMAGES'])) ? $this->_rootref['L_IMAGES'] : ((isset($user->lang['IMAGES'])) ? $user->lang['IMAGES'] : '{ IMAGES }')); ?>:</strong> <?php if ($_postrow_val['U_GALLERY_SEARCH']) {  ?><a href="<?php echo $_postrow_val['U_GALLERY_SEARCH']; ?>"><?php echo $_postrow_val['GALLERY_IMAGES']; ?></a><?php } else { echo $_postrow_val['GALLERY_IMAGES']; } ?></dd><?php } ?><!-- end mod: phpBB Gallery --><?php if ($_postrow_val['POSTER_JOINED']) {  ?><dd><strong><?php echo ((isset($this->_rootref['L_JOINED'])) ? $this->_rootref['L_JOINED'] : ((isset($user->lang['JOINED'])) ? $user->lang['JOINED'] : '{ JOINED }')); ?>:</strong> <?php echo $_postrow_val['POSTER_JOINED']; ?></dd><?php } if ($_postrow_val['POSTER_FROM']) {  ?><dd><strong><?php echo ((isset($this->_rootref['L_LOCATION'])) ? $this->_rootref['L_LOCATION'] : ((isset($user->lang['LOCATION'])) ? $user->lang['LOCATION'] : '{ LOCATION }')); ?>:</strong> <?php echo $_postrow_val['POSTER_FROM']; ?></dd><?php } ?><!-- begin mod: Thanks for posts --><?php if (! $_postrow_val['S_POST_ANONYMOUS'] && $_postrow_val['THANKS_COUNTERS_VIEW']) {  ?>

			<dd><strong><?php echo ((isset($this->_rootref['L_GIVEN'])) ? $this->_rootref['L_GIVEN'] : ((isset($user->lang['GIVEN'])) ? $user->lang['GIVEN'] : '{ GIVEN }')); ?>:</strong><?php if ($_postrow_val['POSTER_GIVE_COUNT'] < (1)) {  ?> <?php echo $_postrow_val['POSTER_GIVE_COUNT']; ?> <?php echo ((isset($this->_rootref['L_THANK'])) ? $this->_rootref['L_THANK'] : ((isset($user->lang['THANK'])) ? $user->lang['THANK'] : '{ THANK }')); } else if ($_postrow_val['POSTER_GIVE_COUNT'] > (1)) {  ?> <a href="<?php echo $_postrow_val['POSTER_GIVE_COUNT_LINK']; ?>"><?php echo $_postrow_val['POSTER_GIVE_COUNT']; ?></a> <?php echo ((isset($this->_rootref['L_THANKS'])) ? $this->_rootref['L_THANKS'] : ((isset($user->lang['THANKS'])) ? $user->lang['THANKS'] : '{ THANKS }')); } else { ?> <a href="<?php echo $_postrow_val['POSTER_GIVE_COUNT_LINK']; ?>"><?php echo $_postrow_val['POSTER_GIVE_COUNT']; ?></a> <?php echo ((isset($this->_rootref['L_THANK'])) ? $this->_rootref['L_THANK'] : ((isset($user->lang['THANK'])) ? $user->lang['THANK'] : '{ THANK }')); } ?></dd>
			<dd><strong><?php echo ((isset($this->_rootref['L_RECEIVED'])) ? $this->_rootref['L_RECEIVED'] : ((isset($user->lang['RECEIVED'])) ? $user->lang['RECEIVED'] : '{ RECEIVED }')); ?>:</strong><?php if ($_postrow_val['POSTER_RECEIVE_COUNT'] < (1)) {  ?> <?php echo $_postrow_val['POSTER_RECEIVE_COUNT']; ?> <?php echo ((isset($this->_rootref['L_THANK'])) ? $this->_rootref['L_THANK'] : ((isset($user->lang['THANK'])) ? $user->lang['THANK'] : '{ THANK }')); } else if ($_postrow_val['POSTER_RECEIVE_COUNT'] > (1)) {  ?> <a href="<?php echo $_postrow_val['POSTER_RECEIVE_COUNT_LINK']; ?>"><?php echo $_postrow_val['POSTER_RECEIVE_COUNT']; ?></a> <?php echo ((isset($this->_rootref['L_THANKS'])) ? $this->_rootref['L_THANKS'] : ((isset($user->lang['THANKS'])) ? $user->lang['THANKS'] : '{ THANKS }')); } else { ?> <a href="<?php echo $_postrow_val['POSTER_RECEIVE_COUNT_LINK']; ?>"><?php echo $_postrow_val['POSTER_RECEIVE_COUNT']; ?></a> <?php echo ((isset($this->_rootref['L_THANK'])) ? $this->_rootref['L_THANK'] : ((isset($user->lang['THANK'])) ? $user->lang['THANK'] : '{ THANK }')); } ?></dd>
		<?php } ?><!-- end mod: Thanks for posts --><?php if ($_postrow_val['S_PROFILE_FIELD1']) {  ?><!-- Use a construct like this to include admin defined profile fields. Replace FIELD1 with the name of your field. -->
