	...
	<div id="topicreview">
		...
		<div class="post bg2 deleted_topic">
			...
			<div class="postbody" id="pr0">
				<h3><?php echo ((isset($this->_rootref['L_PRIME_TOPIC_DELETED_MSG'])) ? $this->_rootref['L_PRIME_TOPIC_DELETED_MSG'] : ((isset($user->lang['PRIME_TOPIC_DELETED_MSG'])) ? $user->lang['PRIME_TOPIC_DELETED_MSG'] : '{ PRIME_TOPIC_DELETED_MSG }')); ?></h3>
				<div class="content">
		...
		<div class="post <?php if (($_postrow_val['S_ROW_COUNT'] & 1)  ) {  ?>bg1<?php } else { ?>bg2<?php } if ($_postrow_val['S_DELETED']) {  ?> deleted_post<?php } ?>">
			<div class="inner"><span class="corners-top"><span></span></span>
