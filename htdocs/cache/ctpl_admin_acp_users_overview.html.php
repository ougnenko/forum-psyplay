...
<!-- mod: Prime Trash Bin (Posts) --><!-- This is the form field used to specify a reason for deleting a user's posts. -->
	<div style="display: none;" id="delete_reason_area">
		...
		<dl>
			<dd><label for="delete_forever"><input type="checkbox" name="delete_forever" id="delete_forever" style="cursor:auto;" onchange="document.getElementById('delete_reason').disabled = this.checked;" /> <?php echo ((isset($this->_rootref['L_PRIME_DELETE_POSTS_FOREVER'])) ? $this->_rootref['L_PRIME_DELETE_POSTS_FOREVER'] : ((isset($user->lang['PRIME_DELETE_POSTS_FOREVER'])) ? $user->lang['PRIME_DELETE_POSTS_FOREVER'] : '{ PRIME_DELETE_POSTS_FOREVER }')); ?></label></dd>
		</dl>
		<?php } ?>
