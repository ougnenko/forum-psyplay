<?php if (!defined('IN_PHPBB')) exit; $this->_tpl_include('overall_header.html'); if ($this->_rootref['U_MCP']) {  ?>
	...
	<br clear="all" /><br />
<?php } ?><!-- begin mod: NV recent topics --><?php if ($this->_rootref['RECENT_TOPICS_DISPLAY']) {  $this->_tpl_include('recent_topics_body.html'); } ?><!-- end mod: NV recent topics --><?php $this->_tpl_include('forumlist_body.html'); if (! $this->_rootref['S_IS_BOT'] || $this->_rootref['U_TEAM']) {  ?>
...
<?php } $this->_tpl_include('index_body_thanks.html'); ?>
...
<tr>
	...
	<td class="row1" width="100%" valign="middle"><p class="genmed"><?php echo (isset($this->_rootref['TOTAL_POSTS'])) ? $this->_rootref['TOTAL_POSTS'] : ''; ?> | <?php echo (isset($this->_rootref['TOTAL_TOPICS'])) ? $this->_rootref['TOTAL_TOPICS'] : ''; if ($this->_rootref['TOTAL_IMAGES']) {  ?> | <?php echo (isset($this->_rootref['TOTAL_IMAGES'])) ? $this->_rootref['TOTAL_IMAGES'] : ''; } ?> | <?php echo (isset($this->_rootref['TOTAL_USERS'])) ? $this->_rootref['TOTAL_USERS'] : ''; ?> | <?php echo (isset($this->_rootref['NEWEST_USER'])) ? $this->_rootref['NEWEST_USER'] : ''; ?></p></td>
</tr>
</table>
