...
<div id="format-buttons">
	...
	<?php }} if ($this->_rootref['S_GALLERY_POPUP']) {  ?>

		<input type="button" class="button2" name="gallery_button" value="<?php echo ((isset($this->_rootref['L_GALLERY_POPUP'])) ? $this->_rootref['L_GALLERY_POPUP'] : ((isset($user->lang['GALLERY_POPUP'])) ? $user->lang['GALLERY_POPUP'] : '{ GALLERY_POPUP }')); ?>" onclick="popup('<?php echo (isset($this->_rootref['U_GALLERY_POPUP'])) ? $this->_rootref['U_GALLERY_POPUP'] : ''; ?>', 800, 600);" title="<?php echo ((isset($this->_rootref['L_GALLERY_POPUP_HELPLINE'])) ? $this->_rootref['L_GALLERY_POPUP_HELPLINE'] : ((isset($user->lang['GALLERY_POPUP_HELPLINE'])) ? $user->lang['GALLERY_POPUP_HELPLINE'] : '{ GALLERY_POPUP_HELPLINE }')); ?>" />
	<?php } ?>
